...
Write-Host "BackgroundAppGlobalToggle status:" -ForegroundColor blue
Edit-RegxDW -rpath "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Search" `
-rname "BackgroundAppGlobalToggle" -rvalue 0
...
Write-Host "SetupSQMTask" -ForegroundColor blue #Proabbly obsolete
Task-Disabling -tskname "SetupSQMTask" -tskpath "\Microsoft\Windows\Customer Experience Improvement Program\"
...
Write-Host "DisableSearchBoxSuggestions status:" -ForegroundColor blue
Edit-RegxDW -rpath "HKCU:\Software\Policies\Microsoft\Windows\Explorer" `
-rname "DisableSearchBoxSuggestions" -rvalue 1
...
Write-Host $BLOCKME -ForegroundColor blue

# Registry keys

Write-Host "StartupBoostEnabled status:" -ForegroundColor blue
Edit-RegxDW -rpath "HKLM:\SOFTWARE\Policies\Microsoft\Edge" `
-rname "StartupBoostEnabled" -rvalue 0

Write-Host

Write-Host "BackgroundModeEnabled status:" -ForegroundColor blue
Edit-RegxDW -rpath "HKLM:\SOFTWARE\Policies\Microsoft\Edge" `
-rname "BackgroundModeEnabled" -rvalue 0
...
Write-Host $BLOCKCOP -ForegroundColor blue

# Registry keys

Write-Host "HKLM TurnOffWindowsCopilot status:" -ForegroundColor blue
Edit-RegxDW -rpath "HKLM:\Software\Policies\Microsoft\Windows\WindowsCopilot" `
-rname "TurnOffWindowsCopilot" -rvalue 1

Write-Host

Write-Host "HKCU TurnOffWindowsCopilot status:" -ForegroundColor blue
Edit-RegxDW -rpath "HKCU:\Software\Policies\Microsoft\Windows\WindowsCopilot" `
-rname "TurnOffWindowsCopilot" -rvalue 1
